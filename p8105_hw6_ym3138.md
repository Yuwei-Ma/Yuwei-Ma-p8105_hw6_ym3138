...
| city_state    | resolved | victim_age | victim_race | victim_sex |   pred | fitted_prob |
|:--------------|---------:|-----------:|:------------|:-----------|-------:|------------:|
| Baltimore, MD |        0 |         17 | Black       | Male       | -0.659 |       0.341 |
| Baltimore, MD |        0 |         26 | Black       | Male       | -0.719 |       0.328 |
| Baltimore, MD |        0 |         21 | Black       | Male       | -0.686 |       0.335 |
| Baltimore, MD |        1 |         61 | White       | Male       | -0.113 |       0.472 |
| Baltimore, MD |        1 |         46 | Black       | Male       | -0.854 |       0.299 |
| Baltimore, MD |        1 |         27 | Black       | Male       | -0.726 |       0.326 |

First 6 rows with fitted probabilities
...
Top 5 Cities by Odds Ratio (Male vs Female)
...
The plot illustrates a widespread disparity in homicide resolution
across major U.S. cities. For nearly all cities, the estimated Odds
Ratio (OR) is less than 1.0, indicating that homicides with male victims
are significantly less likely to be “closed by arrest” than those with
female victims, even after adjusting for victim age and race. Cities
like New York and Long Beach show particularly strong disparities, with
the odds of resolution for males often half that of females.

Albuquerque, NM, stands out as a notable exception with an OR above 1,
suggesting male cases there were more likely to be solved, though the
wide confidence intervals imply uncertainty. Overall, the data reveals a
systemic trend where victim sex remains a powerful predictor of case
clearance, with female victim cases consistently showing higher arrest
rates nationwide.
